...
static void* mmap(KHandle vmo, uintptr_t addr, size_t size, uint32_t prot, uint32_t flags, size_t offset) { return (void*) syscall(SYS_mmap, vmo, addr, size, prot, flags, offset); }
